...
import static com.jyoung.honeystraw.ui.tip.DetailTipActivity.HIDE_TIP_TEXT;
import static com.jyoung.honeystraw.ui.tip.DetailTipActivity.REQ_COMMENT_BACK;
import static com.jyoung.honeystraw.ui.tip.DetailTipActivity.SHOW_TIP_TEXT;

public class DetailTipVerticalActivity extends AppCompatActivity {
    @InjectView(R.id.bottom_bar_vertical)RelativeLayout bottomBar;
    @InjectView(R.id.tip_viewpager_vertical)ViewPager tipviewPager;
    @InjectView(R.id.bottom_bar_page_text_vertical)TextView pageText;
    @InjectView(R.id.bottom_bar_comment_text_vertical)TextView commentText;
    @InjectView(R.id.bottom_bar_comment_image_vertical)ImageView commentImage;
    @InjectView(R.id.bottom_bar_comment_vertical)LinearLayout commentItem;
    @InjectView(R.id.bottom_bar_straw_text_vertical)TextView strawText;
    @InjectView(R.id.detail_tip_background_image_vertical)ImageView backgroundImage;
    @InjectView(R.id.bottom_bar_straw_image_vertical)ImageView strawImage;
    @InjectView(R.id.arrow_down) ImageView arrowImage;
    DetailTipVerticalPagerAdatper tipviewPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_tip_vertical);
    ...
    public void setLayout(){
        ...
        tipviewPagerAdapter = new DetailTipVerticalPagerAdatper(getSupportFragmentManager(), resultData.tipContents.size(), resultData);
    ...
    @OnClick(R.id.bottom_bar_comment_vertical)
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(resultCode == RESULT_OK){
            if(requestCode == REQ_COMMENT_BACK){
                Log.d("dfdf",data.getExtras().getInt("commentCount")+"");
